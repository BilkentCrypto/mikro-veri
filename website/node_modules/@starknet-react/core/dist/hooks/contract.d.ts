import { Abi, AccountInterface, CompiledContract, Contract, ContractFactory, ProviderInterface } from 'starknet';
 ...
 * ```
 */
export declare function useContract({ abi, address }: UseContractProps): UseContractResult;
 ...
 * ```
 */
export declare function useContractFactory({ compiledContract, abi, providerOrAccount, }: UseContractFactoryProps): UseContractFactoryResult;
